        ...
        <div className="min-h-screen bg-background flex flex-col items-center justify-center p-6 bg-[radial-gradient(circle_at_top,_var(--tw-gradient-stops))] from-zinc-900/20 via-background to-background">
            <div className="w-full max-w-[400px] space-y-8">
                ...
                <div className="space-y-2 text-center">
                    ...
                    <p className="text-sm text-muted">Sign in to collaborate on open-source projects</p>
                </div>
                    ...
                    <form onSubmit={handleLogin} className="space-y-4">
                        ...
                        <div className="space-y-2">
                            <div className="flex justify-between items-center px-1">
                                ...
                                <Link href="/forgot-password" core-link="true" className="text-xs text-accent hover:underline">Forgot?</Link>
                            </div>
                            <Input
                                type="password"
                                placeholder="••••••••"
                ...
                <p className="text-center text-xs text-muted">
                    New to the community? <Link href="/builder/signup" className="text-accent hover:underline font-medium">Create Builder account</Link>
                </p>

                <div className="pt-8 text-center">
                    <Link href="/founder/login" className="text-xs text-muted hover:text-foreground transition-colors border-b border-border/50 pb-0.5">
                        Are you a Founder? Switch to Founder login
                    </Link>
                </div>
            </div>
        </div>
