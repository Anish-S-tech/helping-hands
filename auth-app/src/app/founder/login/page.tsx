        ...
        <div className="min-h-screen bg-background flex flex-col items-center justify-center p-6 bg-[radial-gradient(circle_at_top,_var(--tw-gradient-stops))] from-zinc-900/20 via-background to-background">
            <div className="w-full max-w-[400px] space-y-8">
                ...
                <div className="space-y-2 text-center">
                    <h1 className="text-2xl font-semibold tracking-tight">Founder Login</h1>
                    <p className="text-sm text-muted">Enter your credentials to manage your projects</p>
                </div>
                ...
                <div className="p-8 bg-surface-1 border border-border rounded-xl shadow-2xl space-y-6">
                    ...
                    <form onSubmit={handleLogin} className="space-y-4">
                        ...
                        <div className="space-y-2">
                            <div className="flex justify-between items-center px-1">
                                ...
                                <Link href="/forgot-password" title="Forgot Password" className="text-xs text-accent hover:underline">Forgot?</Link>
                            </div>
                            <Input
                                type="password"
                                placeholder="••••••••"
                    ...
                    <div className="relative">
                        ...
                        <div className="relative flex justify-center text-[10px] uppercase tracking-widest">
                            <span className="bg-surface-1 px-3 text-muted">or continue with</span>
                        </div>
                    </div>
                ...
                <p className="text-center text-xs text-muted">
                    New project leader? <Link href="/founder/signup" className="text-accent hover:underline font-medium">Create Founder account</Link>
                </p>

                <div className="pt-8 text-center">
                    <Link href="/builder/login" className="text-xs text-muted hover:text-foreground transition-colors border-b border-border/50 pb-0.5">
                        Are you a Builder? Switch to Builder login
                    </Link>
                </div>
            </div>
        </div>
